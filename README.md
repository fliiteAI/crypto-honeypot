...
- **[Deployment Guide](docs/DEPLOYMENT.md):** Step-by-step instructions for Wazuh Manager and Agent configuration, including OS-specific requirements.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md):** Guide for setting up block explorer watchlists for stolen keys.
