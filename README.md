...
- **[Deployment Guide](docs/DEPLOYMENT.md):** Detailed installation, hardware requirements, and Wazuh/OS configuration.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md):** Guide for setting up block explorer watchlists for exfiltrated keys.
