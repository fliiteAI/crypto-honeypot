...
- **[Deployment Guide](docs/DEPLOYMENT.md)**: Detailed installation and setup instructions, including OS-specific requirements and hardware recommendations.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md)**: Instructions for tracking honeypot addresses on block explorers.
