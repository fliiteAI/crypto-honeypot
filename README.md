...
- **[Deployment Guide](docs/DEPLOYMENT.md):** System requirements, Wazuh configuration, and artifact generation.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md):** Guide for tracking honeypot addresses on-chain.
