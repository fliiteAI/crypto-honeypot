...
For detailed guides on how to deploy and manage the honeypot system, please refer to the following documents:

- **[Deployment Guide](docs/DEPLOYMENT.md)**: Hardware/OS requirements and step-by-step setup.
