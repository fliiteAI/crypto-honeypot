...
- **[Deployment Guide](docs/DEPLOYMENT.md):** Detailed installation and setup instructions, including OS-specific and containerized requirements.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md):** How to set up watchlists for stolen honeypot keys.
