...
- [**Deployment Guide**](docs/DEPLOYMENT.md): Detailed installation, hardware requirements, and Wazuh configuration.
- [**On-Chain Monitoring**](docs/ON_CHAIN_MONITORING.md): Guide for tracking stolen keys on the blockchain.
