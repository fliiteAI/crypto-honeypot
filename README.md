...
- **[Architecture Overview](docs/ARCHITECTURE.md):** Detailed look at the 4-layer detection strategy and MITRE ATT&CK mapping.
- **[Deployment Guide](docs/DEPLOYMENT.md):** Step-by-step instructions for deploying artifacts and configuring Wazuh.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md):** Guide for tracking stolen keys using block explorer watchlists.
