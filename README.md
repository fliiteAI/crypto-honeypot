...
- **[Architecture Overview](docs/ARCHITECTURE.md)**: How the 4-layer detection strategy works.
- **[Deployment Guide](docs/DEPLOYMENT.md)**: Detailed installation and setup instructions, including OS-specific requirements.
