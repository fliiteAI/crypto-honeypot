...
- [**Deployment Guide**](docs/DEPLOYMENT.md) - Detailed installation and setup instructions, including OS-specific requirements and Docker.
- [**On-Chain Monitoring**](docs/ON_CHAIN_MONITORING.md) - Guide for setting up blockchain-level tracking of honeypot addresses.
