...
For detailed guides and technical specifications, please refer to:

- [**Architecture Overview**](docs/ARCHITECTURE.md) - Learn about the 4-layer detection strategy and MITRE ATT&CK mapping.
- [**Deployment Guide**](docs/DEPLOYMENT.md) - Detailed installation, OS requirements, and Wazuh configuration.
