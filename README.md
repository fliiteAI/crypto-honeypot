...
- [Deployment Guide](docs/DEPLOYMENT.md) - Hardware requirements, OS support, and step-by-step setup.
- [On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md) - Setting up watchlists for stolen keys.
