...
- **[Deployment Guide](docs/DEPLOYMENT.md)**: System requirements, Wazuh configuration, and endpoint setup.
- **[On-Chain Monitoring](docs/ON_CHAIN_MONITORING.md)**: Instructions for tracking stolen keys on the blockchain.
