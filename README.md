...
- [**Deployment Guide**](docs/DEPLOYMENT.md) - Step-by-step instructions for Linux, Windows, and Wazuh configuration.
- [**On-Chain Monitoring**](docs/ON_CHAIN_MONITORING.md) - How to track honeypot addresses on-chain.
